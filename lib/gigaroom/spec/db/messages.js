...
// @gigaroom/permissionOverride/hyperdb#7
const encoding20 = {
  preencode (state, m) {
    c.string.preencode(state, m.roomId)
    c.string.preencode(state, m.targetType)
...
function getEncoding (name) {
  switch (name) {
    ...
    case '@gigaroom/writer/hyperdb#0': return encoding13
    case '@gigaroom/invite/hyperdb#1': return encoding14
    case '@gigaroom/message/hyperdb#2': return encoding15
    case '@gigaroom/reaction/hyperdb#3': return encoding16
    case '@gigaroom/room/hyperdb#4': return encoding17
    case '@gigaroom/member/hyperdb#5': return encoding18
    case '@gigaroom/role/hyperdb#6': return encoding19
    case '@gigaroom/permissionOverride/hyperdb#7': return encoding20
    case '@gigaroom/thread/hyperdb#8': return encoding21
    case '@gigaroom/channel/hyperdb#9': return encoding22
    case '@gigaroom/category/hyperdb#10': return encoding23
    case '@gigaroom/file/hyperdb#11': return encoding24
    case '@gigaroom/mention/hyperdb#12': return encoding25
